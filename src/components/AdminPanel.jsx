...
const muiTheme = createTheme({
  ...
  components: {
    MuiTableCell: {
      styleOverrides: { head: { fontWeight: 700, background: "#1b1b22" } },
    },
...
const AdminPanel = () => {
  ...
  const saveBookingEdit = async () => {
    ...
    try {
      ...
      setBookings((prev) =>
        prev.map((b) => (b.id === bkEdit.id ? { ...b, ...payload } : b))
      );
      setBkEdit(null);
  ...
  const validate = () => {
    ...
    if (!placeSelected?.place_id || !placeCoords)
      e.place = "Seleziona un luogo dai suggerimenti";
    setErrors(e);
  ...
  const handleToggleSoldOut = async (id, value) => {
    ...
    setEvents((prev) =>
      prev.map((e) => (e.id === id ? { ...e, soldOut: value } : e))
    );
  };
  ...
  const navItems = [
    ...
    if (role === roles.staff)
      return item.key === "checkin" || item.key === "bookings";
    return true;
  });
      ...
      >
        ...
        <AppBar
          ...
          sx={{
            ...
            color: "primary.main",
            background:
              "linear-gradient(90deg, #0b0b0d 0%, #171722 50%, #222235 100%)",
          ...
          <Toolbar sx={{ gap: 1, justifyContent: "space-between" }}>
            ...
            >
              ...
              >
                ...
                <Badge
                  icon={<EventBusyIcon />}
                  label={`Passati: ${events.filter(isPast).length}`}
                />
                <Badge
                  icon={<ListAltIcon />}
                  label={`Prenotazioni: ${bookings.length}`}
                />
              </Stack>
            </Box>
        ...
        <Drawer
          ...
          sx={{
            ...
            [`& .MuiDrawer-paper`]: {
              ...
              backgroundImage:
                "linear-gradient(180deg, #121218 0%, #171722 100%)",
            },
          }}
        >
          <Toolbar />
                  ...
                  <Table size="small" stickyHeader>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>
                          {t("admin.events.columns.soldOut")}
                        </TableCell>
                          ...
                          >
                            ...
                            <TableCell align="right">
                              ...
                              >
                                ...
                                <Tooltip
                                  title={past ? "Evento passato" : "Modifica"}
                                >
                                  <span>
                                    <Button
                                      size="small"
                                ...
                                <Tooltip
                                  title={past ? "Evento passato" : "Elimina"}
                                >
                                  <span>
                                    <IconButton
                                      size="small"
                      ...
                      <Grid container spacing={1.5}>
                        <Grid item xs={12}>
                          <TextField
                            ...
                            error={!!errors.name}
                            helperText={
                              errors.name || "Esempio: Friday Groove @ Rooftop"
                            }
                            InputProps={{
                              startAdornment: (
                                <InputAdornment position="start">
          ...
          {section === "gallery" && (
            ...
            >
              ...
              <Typography variant="body2" sx={{ mb: 2, opacity: 0.8 }}>
                Le immagini della Home sono lette direttamente dalla cartella
                Drive pubblica.
              </Typography>
              <Button
                variant="outlined"
            ...
            switch (type) {
              ...
              case "event-all": {
                const ids = events
                  .filter((ev) =>
                    filterStatus
                      ? (ev.status || "published") === filterStatus
                      : true
                  )
                  .map((ev) => ev.id);
              ...
              case "booking-all": {
                const ids = bookings
                  .filter((b) =>
                    filterEventId ? b.eventId === filterEventId : true
                  )
                  .map((b) => b.id);
      ...
      >
        ...
        <DialogContent dividers sx={{ display: "grid", gap: 1.2, pt: 2 }}>
          ...
          <TextField
            ...
            onChange={(e) =>
              setBkEdit((s) => ({ ...s, cognome: e.target.value }))
            }
          />
          <TextField
            label="Email"
            value={bkEdit?.email || ""}
            onChange={(e) =>
              setBkEdit((s) => ({ ...s, email: e.target.value }))
            }
          />
          <TextField
            label="Telefono"
            ...
            onChange={(e) =>
              setBkEdit((s) => ({ ...s, telefono: e.target.value }))
            }
          />
          <TextField
            label="Biglietti"
            ...
            onChange={(e) =>
              setBkEdit((s) => ({ ...s, quantity: e.target.value }))
            }
          />
          <FormHelperText>
